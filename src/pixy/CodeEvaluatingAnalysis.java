...
public class CodeEvaluatingAnalysis
extends DepClient {
    ...
    public List<Integer> detectVulns() {
        ...
        try{
            ...
            if(MyOptions.option_CMD){
                ...
                bw.write("<table id=\"rounded-corner\" summary=\"Code Evaluation Scan Report\" >"+ "<tbody>");
                ...
                bw.write("<tfoot>"+
                        ...
                        "<tr>"+
                        "<td colspan=\"4\" class=\"rounded-foot-left\"><em>Code Evaluation Report Cancelled by user</em></td>"+
                        "<td class=\"rounded-foot-right\">&nbsp;</td>"+
                        "</tr>"+
                        "</tfoot>");
                ...
                System.out.println("Code Evaluation Report Creation Cancelled");
                System.out.println("\n");
            }
            bw.close();
