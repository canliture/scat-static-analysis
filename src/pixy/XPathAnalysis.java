    ...
    public List<Integer> detectVulns() {
        ...
        try{
            ...
            if(MyOptions.option_XPath){
                ...
                bw.append("<table id=\"rounded-corner\" summary=\"XPath Injection Scan Report\" >"+
                        "<thead>"+
                        "<tr>"+
                ...
                bw.write("<table id=\"rounded-corner\" summary=\"XPath Injection Scan Report\" >"+ "<tbody>");
                ...
                bw.write("<tfoot>"+
                        ...
                        "<tr>"+
                        "<td colspan=\"4\" class=\"rounded-foot-left\"><em>XPath Injection Report Cancelled by user</em></td>"+
                        "<td class=\"rounded-foot-right\">&nbsp;</td>"+
                        "</tr>"+
                        "</tfoot>");
                ...
                System.out.println("XPath Injection Report Creation Cancelled");
                System.out.println("\n");
            }
            bw.close();
