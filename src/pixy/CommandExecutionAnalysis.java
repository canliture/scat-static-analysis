    ...
    public List<Integer> detectVulns() {
        ...
        try{
            ...
            if(MyOptions.option_CMD){
                ...
                bw.append("<table id=\"rounded-corner\" summary=\"Command Execution Scan Report\" >"+
                        "<thead>"+
                        "<tr>"+
                ...
                bw.write("<table id=\"rounded-corner\" summary=\"Command Execution Scan Report\" >"+ "<tbody>");
                ...
                bw.write("<tfoot>"+
                        ...
                        "<tr>"+
                        "<td colspan=\"4\" class=\"rounded-foot-left\"><em>Command Execution Report Cancelled by user</em></td>"+
                        "<td class=\"rounded-foot-right\">&nbsp;</td>"+
                        "</tr>"+
                        "</tfoot>");
                ...
                System.out.println("Command Execution Report Creation Cancelled");
                System.out.println("\n");
            }
            bw.close();
