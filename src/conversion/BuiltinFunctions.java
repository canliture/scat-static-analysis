...
public class BuiltinFunctions {
	...
	private static Set initBuiltinFunctions() {
		...
		allBuiltinFunctions.add("mysqli_real-escape_string");
		...
		//Mona Nashaat
		allBuiltinFunctions.add("xpath");
		allBuiltinFunctions.add("$xpath->query");
		allBuiltinFunctions.add("simplexml_load_file->xpath");      
	...
	public static void PrintBuiltinFunctions(){
		for( Iterator<String>  func = 	allBuiltinFunctions.iterator(); func.hasNext();)
		{
